...
function test(){
    ...
    if(num>1)
     {
          tem="<p></p>";
          tem+="<p>恭喜你完成本道错题！！其他错题可以前往个人家园查看哦～</p>";
          $("#test_paper").html(tem);            	 
          $("#next_homework").remove();  	 
      }
    else
      {	    	  
           tem+="${homework.homeworkdetails}<br><br>";         
           tem+="<input type='radio' id='aanswer' name='answer' onchange='getAnswer();' value='${homework.aanswer}'>${homework.aanswer}";
          tem+="<input type='radio' id='banswer' name='answer' onchange='getAnswer();' value='${homework.banswer}'>${homework.banswer}";
           tem+="<input type='radio' id='canswer' name='answer' onchange='getAnswer();' value='${homework.canswer}'>${homework.canswer}";
           tem+="<input type='radio' id='danswer' name='answer' onchange='getAnswer();' value='${homework.danswer}'>${homework.danswer}";
             	      
           
           $("#test_paper").html(tem);
           $("#next_homework").text("完成");
           num++;
      }
 ...
 function getAnswer(){
	 var ans=${homework.homeworkanswer};
	 var strAns;
	   for(var i=0;i<ans.length;i++)
	   {
	     ...
	     if(ans.item(i).checked) 
	     {
	    	...
	    	if(strAns==${homework.homeworkanswer} )  alert( "你真棒～ 你怎么这么厉害呢！~" );  
	    	else
	    	{
        ...
        <div class="footer-bottom-bg">
            <div class="container">
                <div class="pull-left">
                    <figure>							<a href="#"><img
								src="${pageContext.request.contextPath}/images/logo/QQ图片20180709201919.png"
								alt="" style="height: 80px; width: 250px;"></a></figure>
                </div>
                <div class="pull-right">
                    <div class="menu">
                        <ul class="clearfix">
