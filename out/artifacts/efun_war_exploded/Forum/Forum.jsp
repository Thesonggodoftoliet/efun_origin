...
<form action="${pageContext.request.contextPath}/Forum/Forum_Posts.jsp" method="post" name="form1"></form>
<body class="home-one">
				...
				<div class="table-outer"> 
					<table class="cart-table">
						<thead class="cart-header">
							<tr>
								<th class="prod-column">&nbsp&nbsp Topic</th>
						...
						<tbody>
							<c:forEach items="${posts}" var="post" varStatus="i">
								...
								-->
									<td class="prod-column"><a href="${pageContext.request.contextPath}/Forum?name=getDetails&id=${post.postsid}" style="color: orange; font-family: Microsoft YaHei;">${post.poststitle}</a></td>
									<td class="price">${users[i.count-1].username}</td>
									<td class="price">${total[i.count-1]}</td>
									<td class="sub-total">${post.poststime}</td>
					...
					<div class="pull-left">
						<div class="apply-coupon clearfix">
							...
							<div class="form-group clearfix">
								<button type="button" class="thm-btn thm-blue-bg btn-style-one" onclick ="form1.submit();">发帖</button>
							</div>
						</div>
					</div>
