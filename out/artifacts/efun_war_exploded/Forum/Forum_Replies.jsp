			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3 col-sm-12">
					<div class="contact-box">
						...
						<form action="${pageContext.request.contextPath}/Forum?name=replies&id=${postsid}" method="post" id="form2">

							<div class="row clearfix">


								<div class="form-group col-lg-12 col-sm-12 col-xs-12">
									<textarea name="message" placeholder="Message(200字以内)" form="form2"></textarea>
								</div>

								<div class="form-group col-lg-12 center">
									<button type="submit" name="submit"
										class="btn-style-one center" form="form2">Submit</button>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<button type="button" name="clear" class="btn-style-one center"
